 ...
 *
 * Больше, чем длится перелёт банка к победителю (380 мс): следующая раздача не
 * должна начинаться, пока фишки ещё едут. Золотая подсветка победителя гаснет
 * на 1330 мс от конца руки — то есть заведомо раньше, чем начнётся новая
 * сдача, и две раздачи визуально не накладываются.
 */
